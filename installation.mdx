---
title: "Install and Activate the Warmr Mac App on Your Machine"
...
<Warning>
  Connecting an iPhone is not the last step. Before it can run activity or post, each device needs its iOS settings configured and the **Warmr runner** installed. A freshly connected phone with no runner won't do anything yet.
</Warning>
...
<Note>
  Warmr needs to stay running on your Mac for ramps and auto-posts to work. Keep the Mac awake and plugged in during runs.
</Note>
