---
title: "Warmr Quickstart: From Zero to Your First Live Ramp"
sidebarTitle: "Quickstart"
description: "Sign up, install the Mac app, prepare an iPhone, install the runner, and start your first account ramp. The full path from zero to a live ramp."
---

This is the complete path from nothing to a live ramp: sign up, install the Mac app, get one iPhone fully set up, and start ramping your first account. Most of the time goes into a **one-time** iPhone setup: connecting it, configuring a few iOS settings, and installing the Warmr runner. Budget around **20–30 minutes** for your first device; every device after that is faster.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/FCF2TGtorPE?rel=0&list=PLqezdr4LtvlLUgYSHr6ccsba-uFiseWgl"
  title="How the Warmr app works"
  frameBorder="0"
...
<Note>
  The iPhone setup steps below (3–5) are the part people skip and then wonder why nothing runs. Don't skip them. An iPhone can't run activity or post until the runner is installed on it.
</Note>
...
<Steps>
  ...
  <Step title="Start your first ramp">
...
<Note>
  Fresh accounts go through a ramp phase before they join your posting rotation, usually a few days, depending on the platform. Warmr blocks posting until an account has matured. See [Account lifecycle](/concepts/account-lifecycle).
</Note>
