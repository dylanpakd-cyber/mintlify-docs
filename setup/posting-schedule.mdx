---
title: "Configure your Warmr posting schedule"
sidebarTitle: "Posting Schedule"
description: "Set time slots for each account and Warmr auto-fills them with your queued content, including a warmup wrapper before and after each post."
---
...
<CardGroup cols={2}>
  <Card title="Cloud Drop" icon="cloud-arrow-up">
    Upload content directly from your phone or laptop to the Warmr cloud. Content drops into the queue automatically and is distributed across accounts in the posting rotation.
  </Card>
  <Card title="Direct from Mac" icon="desktop">
    Drag content files straight into Warmr on your Mac to add them to an account's queue. Useful for precise, per-account content control.
  </Card>
</CardGroup>
