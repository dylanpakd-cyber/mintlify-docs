...
Run through this checklist **once per iPhone, in order, before you install the runner.** Two of these, **Appearance = Light** and **StandBy = Off**, are the most common reason a newly set-up iPhone looks like it's hanging. Do them and you'll avoid the majority of first-run problems.
...
<Warning>
  **The two that matter most.** Set **Appearance** to **Light** (not Dark, not Automatic) and turn **StandBy** **Off**. Skip either and sessions stall silently with no obvious error.
</Warning>
