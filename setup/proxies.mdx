...
<Note>
  New to this? Read **[Proxies, VPNs & IPs: the lingo, explained](/concepts/proxies-and-ips)** first — what
  mobile vs. residential vs. datacenter actually means, why a consumer VPN gets you shadowbanned, whether you
  need an eSIM, and why you need Stash or Shadowrocket. This page is the hands-on setup.
</Note>
